...
@section('data')
    ...
    <div class="row">
        <div class="col-12 col-md-12">
            <div class="row">
                <div class="col-12 col-md-12">
                    <h4>Lista nosača za rentiranje</h4>
                    ...
                    <table class="table table-striped" id="myTable">
                        ...
                        <tbody id="els">
                            ...
                            @if(count($data) > 0)
                                ...
                                @foreach($data as $product)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $product->model_nosaca }}</td>
                                        <td>{{ $product->nosac0103 }}</td>
                                        <td>{{ $product->nosac0407 }}</td>
                                        <td>{{ $product->nosac0812 }}</td>
                                        <td>{{ $product->nosac1320 }}</td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="exampleModal{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="/admin/obrisi-rent-nosac/{{ $product->id }}" class="btn btn-success">Da</a>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @else
                                ...
                                <tr>
                                    <td>Trenutno nema nosača za rentiranje</td>
                                </tr> 
