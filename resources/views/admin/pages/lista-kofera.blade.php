                    ...
                    <table class="table table-striped" id="myTable">
                        ...
                        <tbody id="els">
                            ...
                            @if(count($koferi) > 0)
                                ...
                                @foreach($koferi as $product)

                                    <tr>
                                        <td>
                                            <a class="btn btn-primary" href="/admin/izmeni-kofer/{{ $product->id }}"><i class="far fa-edit"></i> Izmeni</a>
                                            <a class="btn btn-danger" href="#" data-toggle="modal" data-target="#exampleModal{{ $product->id }}"><i class="fas fa-trash-alt"></i> Obriši</a>
                                        </td>
                                        <td><img class="img-fluid" src="images_gallery/{{ $product->main_image }}"></td>
                                        <td>{{ $product->kofer_naziv }}</td>
                                        <td>{{ $product->kofer_cena }}</td>
                                    ...
                                    <div class="modal fade" id="exampleModal{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="/admin/obrisi-kofer/{{ $product->id }}" class="btn btn-success">Da</a>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
